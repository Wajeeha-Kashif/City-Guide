...
<body>
         ...
         <h2>Enter Details</h2>
         <input type="email" class="button" name="email" id="email" placeholder="Your Email"/>
         <br>
         <br>

         <input type="password" class="button" name="password" id="password" placeholder="Password"/>
         <br>
         <br>
          <a href="viewUserProfile.jsp"><button type="button"  class="button">View</button></a>
      </form>
</body>
</html>
