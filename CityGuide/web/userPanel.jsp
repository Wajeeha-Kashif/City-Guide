...
<h1> Welcome To City Guide</h1>
	  ...
	  <form>
         ...
         <a href="ViewProfile.jsp"><button type="button"  class="button">ViewProfile</button></a>
         <br>
         <br>
         <a href="DeleteUser.jsp"><button type="button"  class="button">DeleteAccount</button></a>
         <br>
         <br>
         <a href="registration.jsp"><button type="button"  class="button">SignUp</button></a>
