...
<body>
    ...
    <form >
       ...
       <h2>Enter Details</h2>
         <input type="text" class="button" name="Name" placeholder="Company Name"/>
         <br>
         <br>

         <input type="text" class="button" name="Type" placeholder="Job Offer"/>
         <br>
         <br>
         ...
         <br>
         <br>
         <input type="text" class="button" name="Location" placeholder="Qualification"/>
         <br>
         <br>
