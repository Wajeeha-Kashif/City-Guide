...
<body>
	           ...
	           <form    action="<%= request.getContextPath() %>/RemoveInstituteServlet" method="post" >
          
         <h2>Enter Details</h2>
         <input type="text" class="button" name="Name" placeholder="Institue Name"/>
         <br>
         <br>
         <input type="submit" id="special"name="Remove" value="Remove" >
      </form>
